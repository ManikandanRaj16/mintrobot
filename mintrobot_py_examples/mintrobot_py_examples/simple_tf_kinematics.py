...
from mintrobot_msgs.srv import GetTransform
...
class SimpleTfKinematics(Node):
    ...
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "mintrobot_base"
        self.static_transform_stamped_.child_frame_id = "mintrobot_top"
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "mintrobot_base"
